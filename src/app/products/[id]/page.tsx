...
export default function DetailPage() {
    ...
    useEffect(() => {
        if (params?.id) {
            setManufacturerId(params.id);
        }
    }, [params]);
    const { data, error } = useSWR(`http://localhost:3001/sp_nhasx/${manufacturerId}`, fetcher, {
    ...
    const filteredData = data
        ...
        .filter((item: any) => item.gia_km >= minPrice && item.gia_km <= maxPrice)
        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex flex-col">
                    <label htmlFor="minPrice" className="text-lg font-medium text-gray-700">
                ...
                <div className="flex flex-col">
                    <label htmlFor="maxPrice" className="text-lg font-medium text-gray-700">
